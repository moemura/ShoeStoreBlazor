    ...
    <footer className="bg-gray-100">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About */}
          <div>
            <h3 className="font-semibold text-lg mb-4">Về ShoeStore</h3>
            <p className="text-gray-600 mb-4">
              Chuyên cung cấp các sản phẩm giày dép chất lượng cao với giá cả phải chăng.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/promotions" className="text-gray-600 hover:text-gray-900">
                  Khuyến mãi
                </Link>
              </li>
              <li>
